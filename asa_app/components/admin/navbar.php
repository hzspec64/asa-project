        ...
        <ul class="list-unstyled d-flex align-items-center mb-0 gap-1">
            ...
            <li>
                <a class="position-relative btn-icon btn-sm btn-light btn rounded-circle" data-bs-toggle="dropdown" aria-expanded="false" href="#" role="button">
                    ...
                    <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger mt-2 ms-n2"> 2 <span class="visually-hidden">unread messages</span>
                    </span>
                </a>
                    ...
                    <ul class="list-unstyled p-0 m-0">
                        <li class="p-3 border-bottom ">
                            <div class="d-flex gap-3">
                                <img src="/assets/admin/images/avatar/avatar-1.jpg" alt="" class="avatar avatar-sm rounded-circle" />
                        ...
                        <li class="p-3 border-bottom ">
                            <div class="d-flex gap-3">
                                <img src="/assets/admin/images/avatar/avatar-4.jpg" alt="" class="avatar avatar-sm rounded-circle" />
                                <div class="flex-grow-1 small">
                        ...
                        <li class="p-3 border-bottom">
                            <div class="d-flex gap-3">
                                <img src="/assets/admin/images/avatar/avatar-2.jpg" alt="" class="avatar avatar-sm rounded-circle" />
                                <div class="flex-grow-1 small">
