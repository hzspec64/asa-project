                            ...
                            <table class="table mb-0 text-nowrap table-hover">
                                ...
                                <tbody>
                                    <tr class="align-middle ">
                                        <td>
                                            <a href="">
                                                <img src="/assets/admin/images/product-1.png" alt="" class="avatar avatar-md rounded" />
                                    ...
                                    <tr class="align-middle">
                                        <td>
                                            <a href="">
                                                <img src="/assets/admin/images/product-2.png" alt="" class="avatar avatar-md rounded" />
                                    ...
                                    <tr class="align-middle">
                                        <td>
                                            <a href="">
                                                <img src="/assets/admin/images/product-3.png" alt="" class="avatar avatar-md rounded" />
                                    ...
                                    <tr class="align-middle">
                                        <td>
                                            <a href="">
                                                <img src="/assets/admin/images/product-4.png" alt="" class="avatar avatar-md rounded" />
                                    ...
                                    <tr class="align-middle">
                                        <td>
                                            <a href="">
                                                <img src="/assets/admin/images/product-5.png" alt="" class="avatar avatar-md rounded" />
                                    ...
                                    <tr class="align-middle">
                                        <td>
                                            <a href="">
                                                <img src="/assets/admin/images/product-6.png" alt="" class="avatar avatar-md rounded" />
                                    ...
                                    <tr class="align-middle">
                                        <td>
                                            <a href="">
                                                <img src="/assets/admin/images/product-7.png" alt="" class="avatar avatar-md rounded" />
                                    ...
                                    <tr class="align-middle">
                                        <td>
                                            <a href="">
                                                <img src="/assets/admin/images/product-8.png" alt="" class="avatar avatar-md rounded" />
                                                <span class="ms-3">Wireless Earphones</span>
                                            </a>
                                        </td>
                                        <td>PRD008</td>
