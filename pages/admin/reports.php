                        ...
                        <div class="card h-100">
                            <div class="card-body p-4">
                                ...
                                <p class="mb-0 text-success small">
                                    <i class="ti ti-arrow-up"></i>12% from last month
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="card h-100">
                            <div class="card-body p-4">
                                ...
                                <p class="mb-0 text-success small">
                                    <i class="ti ti-arrow-up"></i> 8% from last month
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card h-100">
                            <div class="card-body p-4">
                                ...
                                <p class="mb-0 text-danger small">
                                    <i class="ti ti-arrow-down"></i> 3% from last month
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="card h-100">
                            <div class="card-body p-4">
                                ...
                                <p class="mb-0 text-danger small">
                                    <i class="ti ti-arrow-down"></i> 2% from last month
                                </p>
                            </div>
                        </div>
                    </div>
