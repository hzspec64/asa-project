                            ...
                            <div class="">
                                ...
                                <div class="mb-4">
                                    ...
                                    <ol class="list-group list-group-numbered list-group-flush">
                                        ...
                                        <li class="list-group-item ps-0"> Install dependencies:
                                            <pre class="bg-light border rounded p-3 mt-2">
                                ...
                                <div class="mb-4">
                                    ...
                                    <ol class="list-group list-group-numbered list-group-flush">
                                        <li class="list-group-item ps-0">Review the main entry point in <code>src/js/main.js</code>
                                        </li>
                                        <li class="list-group-item ps-0">Customize components according to your needs</li>
                                        <li class="list-group-item ps-0"> Build for production:
                                            <pre class="bg-light border rounded p-3 mt-4">
...
└── .gitignore          # Git ignore file
                                ...
                                <div class="mb-2">
                                    ...
                                    <p> For issues or questions, please refer to the documentation or create an issue in the repository. Also you can contact us at <a href="#!" class="text-primary">CodesCandy</a>. </p>
                                </div>
                            </div>
                        </div>
                    </div>
