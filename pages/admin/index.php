                ...
                <div class="row g-3">
                        ...
                        <div class="card  h-100">
                            <div class="card-header bg-white d-flex justify-content-between align-items-center px-4 py-3">
                                ...
                                <button class="btn btn-sm btn-outline-secondary">
                                    <i class="ti ti-calendar"></i> Today </button>
                            </div>
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item d-flex align-items-center gap-3">
                                    <img src="/assets/admin/images/product-3.png" class="rounded" width="48">
                                    <div class="flex-grow-1">
                                ...
                                <li class="list-group-item d-flex align-items-center gap-3">
                                    <img src="/assets/admin/images/product-4.png" class="rounded" width="48">
                                    <div class="flex-grow-1">
                    ...
                    <div class="col-lg-4">
                        <div class="card  h-100">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex align-items-center gap-3">
                                    <img src="/assets/admin/images/product-8.png" class="rounded" width="48">
                                    <div class="flex-grow-1">
                                ...
                                <li class="list-group-item d-flex align-items-center gap-3">
                                    <img src="/assets/admin/images/product-6.png" class="rounded" width="48">
                                    <div class="flex-grow-1">
                    ...
                    <div class="col-lg-4">
                        <div class="card  h-100">
                            <div class="card-header bg-white d-flex justify-content-between align-items-center px-4 py-3">
                                ...
                                <button class="btn btn-sm btn-outline-secondary">
                                    <i class="ti ti-calendar-event"></i> Weekly </button>
                            </div>
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex align-items-center gap-3">
